...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $klass = Opal.klass, $hash2 = Opal.hash2, $range = Opal.range;

  Opal.add_stubs(['$attr_reader', '$remove', '$add', '$const_defined?', '$opacity', '$color', '$opacity=', '$-', '$raise', '$map', '$new', '$[]', '$length', '$each', '$!', '$is_valid?', '$class', '$===', '$==', '$rand', '$is_hex?', '$hex_to_f', '$key?', '$all?', '$is_a?', '$private', '$push', '$/', '$each_slice', '$chars', '$to_proc', '$to_i', '$to_f', '$attr_accessor', '$next', '$ext_get_display_dimensions', '$add_object', '$index', '$delete_at', '$clear', '$has_key?', '$new_event_key', '$[]=', '$delete', '$type', '$id', '$downcase', '$call', '$ext_show', '$ext_close', '$include?', '$>', '$z', '$insert', '$get', '$set', '$on', '$off', '$update', '$show', '$close', '$include', '$color=', '$from', '$update_color', '$+', '$triangle_area', '$<=', '$abs', '$*', '$points_distance', '$<', '$x1', '$y1', '$x2', '$y2', '$sqrt', '$**', '$update_coords', '$height=', '$width=', '$ext_init', '$clip', '$merge!', '$!=', '$animate_frames', '$clip_with_current_frame', '$to_s', '$ext_set', '$=~', '$exists?', '$ext_play', '$ext_pause', '$ext_resume', '$ext_stop', '$ext_fadeout']);
  
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting);

    (function($base, $parent_nesting) {
      var $Renderable, self = $Renderable = $module($base, 'Renderable');

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Renderable_z$eq_1, TMP_Renderable_add_2, TMP_Renderable_remove_3, TMP_Renderable_opacity_4, TMP_Renderable_opacity$eq_5, TMP_Renderable_contains$q_6;

      
      self.$attr_reader("z");
      
      Opal.defn(self, '$z=', TMP_Renderable_z$eq_1 = function(z) {
        var self = this;
        ...
        self.z = z;
        return self.$add();
      }, TMP_Renderable_z$eq_1.$$arity = 1);
      
      Opal.defn(self, '$add', TMP_Renderable_add_2 = function $$add() {
        var self = this;

        if ($truthy(Opal.const_get_relative($nesting, 'Module')['$const_defined?']("DSL"))) {
          return Opal.const_get_relative($nesting, 'Application').$add(self)
          } else {
          return nil
        }
      }, TMP_Renderable_add_2.$$arity = 0);
      
      Opal.defn(self, '$remove', TMP_Renderable_remove_3 = function $$remove() {
        var self = this;

        if ($truthy(Opal.const_get_relative($nesting, 'Module')['$const_defined?']("DSL"))) {
          return Opal.const_get_relative($nesting, 'Application').$remove(self)
          } else {
          return nil
        }
      }, TMP_Renderable_remove_3.$$arity = 0);
      
      Opal.defn(self, '$opacity', TMP_Renderable_opacity_4 = function $$opacity() {
        var self = this;

        return self.$color().$opacity()
      }, TMP_Renderable_opacity_4.$$arity = 0);
      
      Opal.defn(self, '$opacity=', TMP_Renderable_opacity$eq_5 = function(val) {
        var self = this, $writer = nil;

        
        $writer = [val];
        $send(self.$color(), 'opacity=', Opal.to_a($writer));
        return $writer[$rb_minus($writer["length"], 1)];
      }, TMP_Renderable_opacity$eq_5.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Renderable_contains$q_6 = function(x, y) {
        var self = this;

        return self.$raise("Not implemented yet")
      }, TMP_Renderable_contains$q_6.$$arity = 2);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Color_initialize_14, TMP_Color_is_hex$q_15, TMP_Color_is_valid$q_17, TMP_Color_from_19, TMP_Color_opacity_20, TMP_Color_opacity$eq_21, TMP_Color_to_f_23, TMP_Color_hex_to_f_25;
      ...
      (function($base, $super, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Set_initialize_8, TMP_Set_$$_9, TMP_Set_length_10, TMP_Set_opacity_11, TMP_Set_opacity$eq_13;

        def.colors = nil;
        
        
        Opal.defn(self, '$initialize', TMP_Set_initialize_8 = function $$initialize(colors) {
          var TMP_7, self = this;

          return (self.colors = $send(colors, 'map', [], (TMP_7 = function(c){var self = TMP_7.$$s || this;
if (c == null) c = nil;
          return Opal.const_get_relative($nesting, 'Color').$new(c)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7)))
        }, TMP_Set_initialize_8.$$arity = 1);
        
        Opal.defn(self, '$[]', TMP_Set_$$_9 = function(i) {
          var self = this;

          return self.colors['$[]'](i)
        }, TMP_Set_$$_9.$$arity = 1);
        
        Opal.defn(self, '$length', TMP_Set_length_10 = function $$length() {
          var self = this;

          return self.colors.$length()
        }, TMP_Set_length_10.$$arity = 0);
        
        Opal.defn(self, '$opacity', TMP_Set_opacity_11 = function $$opacity() {
          var self = this;

          return self.colors['$[]'](0).$opacity()
        }, TMP_Set_opacity_11.$$arity = 0);
        return (Opal.defn(self, '$opacity=', TMP_Set_opacity$eq_13 = function(opacity) {
          var TMP_12, self = this;

          return $send(self.colors, 'each', [], (TMP_12 = function(color){var self = TMP_12.$$s || this, $writer = nil;
if (color == null) color = nil;
          
            $writer = [opacity];
            $send(color, 'opacity=', Opal.to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12))
        }, TMP_Set_opacity$eq_13.$$arity = 1), nil) && 'opacity=';
      })($nesting[0], null, $nesting);
      self.$attr_reader("r", "g", "b", "a");
      (Opal.class_variable_set($Color, '@@colors', $hash2(["navy", "blue", "aqua", "teal", "olive", "green", "lime", "yellow", "orange", "red", "brown", "fuchsia", "purple", "maroon", "white", "silver", "gray", "black", "random"], {"navy": "#001F3F", "blue": "#0074D9", "aqua": "#7FDBFF", "teal": "#39CCCC", "olive": "#3D9970", "green": "#2ECC40", "lime": "#01FF70", "yellow": "#FFDC00", "orange": "#FF851B", "red": "#FF4136", "brown": "#663300", "fuchsia": "#F012BE", "purple": "#B10DC9", "maroon": "#85144B", "white": "#FFFFFF", "silver": "#DDDDDD", "gray": "#AAAAAA", "black": "#111111", "random": ""})));
      
      Opal.defn(self, '$initialize', TMP_Color_initialize_14 = function $$initialize(c) {
        var $a, $b, $c, self = this, $case = nil;

        if ($truthy(self.$class()['$is_valid?'](c)['$!']())) {
          return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "`" + (c) + "` is not a valid color")
          } else {
          return (function() {$case = c;
          if (Opal.const_get_relative($nesting, 'String')['$===']($case)) {if (c['$==']("random")) {
            return $a = [self.$rand(), self.$rand(), self.$rand(), 1.0], (self.r = $a[0]), (self.g = $a[1]), (self.b = $a[2]), (self.a = $a[3]), $a
          } else if ($truthy(self.$class()['$is_hex?'](c))) {
            return $b = self.$hex_to_f(c), $a = Opal.to_ary($b), (self.r = ($a[0] == null ? nil : $a[0])), (self.g = ($a[1] == null ? nil : $a[1])), (self.b = ($a[2] == null ? nil : $a[2])), (self.a = ($a[3] == null ? nil : $a[3])), $b
            } else {
            return $b = self.$hex_to_f((($c = $Color.$$cvars['@@colors']) == null ? nil : $c)['$[]'](c)), $a = Opal.to_ary($b), (self.r = ($a[0] == null ? nil : $a[0])), (self.g = ($a[1] == null ? nil : $a[1])), (self.b = ($a[2] == null ? nil : $a[2])), (self.a = ($a[3] == null ? nil : $a[3])), $b
          }}
          else if (Opal.const_get_relative($nesting, 'Array')['$===']($case)) {return $a = [c['$[]'](0), c['$[]'](1), c['$[]'](2), c['$[]'](3)], (self.r = $a[0]), (self.g = $a[1]), (self.b = $a[2]), (self.a = $a[3]), $a}
          else { return nil }})()
        }
      }, TMP_Color_initialize_14.$$arity = 1);
      Opal.defs(self, '$is_hex?', TMP_Color_is_hex$q_15 = function(s) {
        var $a, $b, self = this;

        return ($truthy($a = (($b = s.$class()['$=='](Opal.const_get_relative($nesting, 'String'))) ? s['$[]'](0)['$==']("#") : s.$class()['$=='](Opal.const_get_relative($nesting, 'String')))) ? s.$length()['$=='](7) : $a)
      }, TMP_Color_is_hex$q_15.$$arity = 1);
      Opal.defs(self, '$is_valid?', TMP_Color_is_valid$q_17 = function(c) {
        var $a, $b, $c, TMP_16, self = this;

        return ($truthy($a = ($truthy($b = (($c = $Color.$$cvars['@@colors']) == null ? nil : $c)['$key?'](c)) ? $b : self['$is_hex?'](c))) ? $a : ($truthy($b = (($c = c.$class()['$=='](Opal.const_get_relative($nesting, 'Array'))) ? c.$length()['$=='](4) : c.$class()['$=='](Opal.const_get_relative($nesting, 'Array')))) ? $send(c, 'all?', [], (TMP_16 = function(el){var self = TMP_16.$$s || this;
if (el == null) el = nil;
        return el['$is_a?'](Opal.const_get_relative($nesting, 'Numeric'))}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16)) : $b))
      }, TMP_Color_is_valid$q_17.$$arity = 1);
      Opal.defs(self, '$from', TMP_Color_from_19 = function $$from(input) {
        var $a, TMP_18, self = this;

        if ($truthy(($truthy($a = input['$is_a?'](Opal.const_get_relative($nesting, 'Array'))) ? $send(input, 'all?', [], (TMP_18 = function(el){var self = TMP_18.$$s || this;
if (el == null) el = nil;
        return Opal.const_get_relative($nesting, 'Color')['$is_valid?'](el)}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18)) : $a))) {
          return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Color'), 'Set').$new(input)
          } else {
          return Opal.const_get_relative($nesting, 'Color').$new(input)
        }
      }, TMP_Color_from_19.$$arity = 1);
      
      Opal.defn(self, '$opacity', TMP_Color_opacity_20 = function $$opacity() {
        var self = this;

        return self.a
      }, TMP_Color_opacity_20.$$arity = 0);
      
      Opal.defn(self, '$opacity=', TMP_Color_opacity$eq_21 = function(opacity) {
        var self = this;

        return (self.a = opacity)
      }, TMP_Color_opacity$eq_21.$$arity = 1);
      self.$private();
      
      Opal.defn(self, '$to_f', TMP_Color_to_f_23 = function $$to_f(a) {
        var TMP_22, self = this, b = nil;

        
        b = [];
        $send(a, 'each', [], (TMP_22 = function(n){var self = TMP_22.$$s || this;
if (n == null) n = nil;
        return b.$push($rb_divide(n, 255.0))}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22));
        return b;
      }, TMP_Color_to_f_23.$$arity = 1);
      return (Opal.defn(self, '$hex_to_f', TMP_Color_hex_to_f_25 = function $$hex_to_f(h) {
        var TMP_24, self = this, a = nil;

        
        h = $send(h['$[]']($range(1, -1, false)).$chars().$each_slice(2), 'map', [], "join".$to_proc());
        a = [];
        $send(h, 'each', [], (TMP_24 = function(el){var self = TMP_24.$$s || this;
if (el == null) el = nil;
        return a.$push(el.$to_i(16))}, TMP_24.$$s = self, TMP_24.$$arity = 1, TMP_24));
        a.$push(255);
        return self.$to_f(a);
      }, TMP_Color_hex_to_f_25.$$arity = 1), nil) && 'hex_to_f';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Window_initialize_27, TMP_Window_new_event_key_28, TMP_Window_get_29, TMP_Window_set_30, TMP_Window_add_32, TMP_Window_remove_33, TMP_Window_clear_34, TMP_Window_update_35, TMP_Window_on_36, TMP_Window_off_37, TMP_Window_key_callback_42, TMP_Window_mouse_callback_48, TMP_Window_controller_callback_53, TMP_Window_update_callback_54, TMP_Window_show_55, TMP_Window_close_56, TMP_Window_add_object_58;

      def.fps_cap = def.event_key = def.title = def.background = def.width = def.height = def.viewport_width = def.viewport_height = def.display_width = def.display_height = def.resizable = def.borderless = def.fullscreen = def.highdpi = def.frames = def.fps = def.mouse_x = def.mouse_y = def.diagnostics = def.objects = def.events = def.update_proc = nil;
      
      self.$attr_reader("objects");
      self.$attr_accessor("mouse_x", "mouse_y", "frames", "fps");
      Opal.const_set($nesting[0], 'EventDescriptor', Opal.const_get_relative($nesting, 'Struct').$new("type", "id"));
      Opal.const_set($nesting[0], 'MouseEvent', Opal.const_get_relative($nesting, 'Struct').$new("type", "button", "direction", "x", "y", "delta_x", "delta_y"));
      Opal.const_set($nesting[0], 'KeyEvent', Opal.const_get_relative($nesting, 'Struct').$new("type", "key"));
      Opal.const_set($nesting[0], 'ControllerEvent', Opal.const_get_relative($nesting, 'Struct').$new("which", "type", "axis", "value", "button"));
      Opal.const_set($nesting[0], 'ControllerAxisEvent', Opal.const_get_relative($nesting, 'Struct').$new("which", "axis", "value"));
      Opal.const_set($nesting[0], 'ControllerButtonEvent', Opal.const_get_relative($nesting, 'Struct').$new("which", "button"));
      
      Opal.defn(self, '$initialize', TMP_Window_initialize_27 = function $$initialize(args) {
        var $a, TMP_26, self = this;

        if (args == null) {
          args = $hash2([], {});
        }
        
        self.title = ($truthy($a = args['$[]']("title")) ? $a : "Ruby 2D");
        self.background = Opal.const_get_relative($nesting, 'Color').$new([0.0, 0.0, 0.0, 1.0]);
        self.width = ($truthy($a = args['$[]']("width")) ? $a : 640);
        self.height = ($truthy($a = args['$[]']("height")) ? $a : 480);
        $a = [nil, nil], (self.viewport_width = $a[0]), (self.viewport_height = $a[1]), $a;
        $a = [nil, nil], (self.display_width = $a[0]), (self.display_height = $a[1]), $a;
        self.resizable = false;
        self.borderless = false;
        self.fullscreen = false;
        self.highdpi = false;
        self.frames = 0;
        self.fps_cap = ($truthy($a = args['$[]']("fps")) ? $a : 60);
        self.fps = self.fps_cap;
        self.vsync = ($truthy($a = args['$[]']("vsync")) ? $a : true);
        $a = [0, 0], (self.mouse_x = $a[0]), (self.mouse_y = $a[1]), $a;
        self.objects = [];
        self.event_key = 0;
        self.events = $hash2(["key", "key_down", "key_held", "key_up", "mouse", "mouse_up", "mouse_down", "mouse_scroll", "mouse_move", "controller", "controller_axis", "controller_button_down", "controller_button_up"], {"key": $hash2([], {}), "key_down": $hash2([], {}), "key_held": $hash2([], {}), "key_up": $hash2([], {}), "mouse": $hash2([], {}), "mouse_up": $hash2([], {}), "mouse_down": $hash2([], {}), "mouse_scroll": $hash2([], {}), "mouse_move": $hash2([], {}), "controller": $hash2([], {}), "controller_axis": $hash2([], {}), "controller_button_down": $hash2([], {}), "controller_button_up": $hash2([], {})});
        self.update_proc = $send(Opal.const_get_relative($nesting, 'Proc'), 'new', [], (TMP_26 = function(){var self = TMP_26.$$s || this;

        return nil}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26));
        return (self.diagnostics = false);
      }, TMP_Window_initialize_27.$$arity = -1);
      
      Opal.defn(self, '$new_event_key', TMP_Window_new_event_key_28 = function $$new_event_key() {
        var self = this;

        return (self.event_key = self.event_key.$next())
      }, TMP_Window_new_event_key_28.$$arity = 0);
      
      Opal.defn(self, '$get', TMP_Window_get_29 = function $$get(sym) {
        var self = this, $case = nil;

        return (function() {$case = sym;
        if ("window"['$===']($case)) {return self}
        else if ("title"['$===']($case)) {return self.title}
        else if ("background"['$===']($case)) {return self.background}
        else if ("width"['$===']($case)) {return self.width}
        else if ("height"['$===']($case)) {return self.height}
        else if ("viewport_width"['$===']($case)) {return self.viewport_width}
        else if ("viewport_height"['$===']($case)) {return self.viewport_height}
        else if ("display_width"['$===']($case) || "display_height"['$===']($case)) {
        self.$ext_get_display_dimensions();
        if (sym['$==']("display_width")) {
          return self.display_width
          } else {
          return self.display_height
        };}
        else if ("resizable"['$===']($case)) {return self.resizable}
        else if ("borderless"['$===']($case)) {return self.borderless}
        else if ("fullscreen"['$===']($case)) {return self.fullscreen}
        else if ("highdpi"['$===']($case)) {return self.highdpi}
        else if ("frames"['$===']($case)) {return self.frames}
        else if ("fps"['$===']($case)) {return self.fps}
        else if ("mouse_x"['$===']($case)) {return self.mouse_x}
        else if ("mouse_y"['$===']($case)) {return self.mouse_y}
        else if ("diagnostics"['$===']($case)) {return self.diagnostics}
        else { return nil }})()
      }, TMP_Window_get_29.$$arity = 1);
      
      Opal.defn(self, '$set', TMP_Window_set_30 = function $$set(opts) {
        var $a, self = this;

        
        self.title = ($truthy($a = opts['$[]']("title")) ? $a : self.title);
        if ($truthy(Opal.const_get_relative($nesting, 'Color')['$is_valid?'](opts['$[]']("background")))) {
          self.background = Opal.const_get_relative($nesting, 'Color').$new(opts['$[]']("background"))};
        self.width = ($truthy($a = opts['$[]']("width")) ? $a : self.width);
        self.height = ($truthy($a = opts['$[]']("height")) ? $a : self.height);
        self.viewport_width = ($truthy($a = opts['$[]']("viewport_width")) ? $a : self.viewport_width);
        self.viewport_height = ($truthy($a = opts['$[]']("viewport_height")) ? $a : self.viewport_height);
        self.resizable = ($truthy($a = opts['$[]']("resizable")) ? $a : self.resizable);
        self.borderless = ($truthy($a = opts['$[]']("borderless")) ? $a : self.borderless);
        self.fullscreen = ($truthy($a = opts['$[]']("fullscreen")) ? $a : self.fullscreen);
        self.highdpi = ($truthy($a = opts['$[]']("highdpi")) ? $a : self.highdpi);
        return (self.diagnostics = ($truthy($a = opts['$[]']("diagnostics")) ? $a : self.diagnostics));
      }, TMP_Window_set_30.$$arity = 1);
      
      Opal.defn(self, '$add', TMP_Window_add_32 = function $$add(o) {
        var TMP_31, self = this, $case = nil;

        return (function() {$case = o;
        if (nil['$===']($case)) {return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Cannot add '" + (o.$class()) + "' to window!")}
        else if (Opal.const_get_relative($nesting, 'Array')['$===']($case)) {return $send(o, 'each', [], (TMP_31 = function(x){var self = TMP_31.$$s || this;
if (x == null) x = nil;
        return self.$add_object(x)}, TMP_31.$$s = self, TMP_31.$$arity = 1, TMP_31))}
        else {return self.$add_object(o)}})()
      }, TMP_Window_add_32.$$arity = 1);
      
      Opal.defn(self, '$remove', TMP_Window_remove_33 = function $$remove(o) {
        var self = this, i = nil;

        
        if (o['$=='](nil)) {
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Cannot remove '" + (o.$class()) + "' from window!")};
        if ($truthy((i = self.objects.$index(o)))) {
          
          self.objects.$delete_at(i);
          return true;
          } else {
          return false
        };
      }, TMP_Window_remove_33.$$arity = 1);
      
      Opal.defn(self, '$clear', TMP_Window_clear_34 = function $$clear() {
        var self = this;

        return self.objects.$clear()
      }, TMP_Window_clear_34.$$arity = 0);
      
      Opal.defn(self, '$update', TMP_Window_update_35 = function $$update() {
        var self = this, $iter = TMP_Window_update_35.$$p, proc = $iter || nil;

        if ($iter) TMP_Window_update_35.$$p = null;
        
        self.update_proc = proc;
        return true;
      }, TMP_Window_update_35.$$arity = 0);
      
      Opal.defn(self, '$on', TMP_Window_on_36 = function $$on(event) {
        var self = this, $iter = TMP_Window_on_36.$$p, proc = $iter || nil, event_id = nil, $writer = nil;

        if ($iter) TMP_Window_on_36.$$p = null;
        
        if ($truthy(self.events['$has_key?'](event))) {
          } else {
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "`" + (event) + "` is not a valid event type")
        };
        event_id = self.$new_event_key();
        
        $writer = [event_id, proc];
        $send(self.events['$[]'](event), '[]=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        return Opal.const_get_relative($nesting, 'EventDescriptor').$new(event, event_id);
      }, TMP_Window_on_36.$$arity = 1);
      
      Opal.defn(self, '$off', TMP_Window_off_37 = function $$off(event_descriptor) {
        var self = this;

        return self.events['$[]'](event_descriptor.$type()).$delete(event_descriptor.$id())
      }, TMP_Window_off_37.$$arity = 1);
      
      Opal.defn(self, '$key_callback', TMP_Window_key_callback_42 = function $$key_callback(type, key) {
        var TMP_38, TMP_39, TMP_40, TMP_41, self = this, $case = nil;

        
        key = key.$downcase();
        $send(self.events['$[]']("key"), 'each', [], (TMP_38 = function(id, e){var self = TMP_38.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'KeyEvent').$new(type, key))}, TMP_38.$$s = self, TMP_38.$$arity = 2, TMP_38));
        return (function() {$case = type;
        if ("down"['$===']($case)) {return $send(self.events['$[]']("key_down"), 'each', [], (TMP_39 = function(id, e){var self = TMP_39.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'KeyEvent').$new(type, key))}, TMP_39.$$s = self, TMP_39.$$arity = 2, TMP_39))}
        else if ("held"['$===']($case)) {return $send(self.events['$[]']("key_held"), 'each', [], (TMP_40 = function(id, e){var self = TMP_40.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'KeyEvent').$new(type, key))}, TMP_40.$$s = self, TMP_40.$$arity = 2, TMP_40))}
        else if ("up"['$===']($case)) {return $send(self.events['$[]']("key_up"), 'each', [], (TMP_41 = function(id, e){var self = TMP_41.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'KeyEvent').$new(type, key))}, TMP_41.$$s = self, TMP_41.$$arity = 2, TMP_41))}
        else { return nil }})();
      }, TMP_Window_key_callback_42.$$arity = 2);
      
      Opal.defn(self, '$mouse_callback', TMP_Window_mouse_callback_48 = function $$mouse_callback(type, button, direction, x, y, delta_x, delta_y) {
        var TMP_43, TMP_44, TMP_45, TMP_46, TMP_47, self = this, $case = nil;

        
        $send(self.events['$[]']("mouse"), 'each', [], (TMP_43 = function(id, e){var self = TMP_43.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'MouseEvent').$new(type, button, direction, x, y, delta_x, delta_y))}, TMP_43.$$s = self, TMP_43.$$arity = 2, TMP_43));
        return (function() {$case = type;
        if ("down"['$===']($case)) {return $send(self.events['$[]']("mouse_down"), 'each', [], (TMP_44 = function(id, e){var self = TMP_44.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'MouseEvent').$new(type, button, nil, x, y, nil, nil))}, TMP_44.$$s = self, TMP_44.$$arity = 2, TMP_44))}
        else if ("up"['$===']($case)) {return $send(self.events['$[]']("mouse_up"), 'each', [], (TMP_45 = function(id, e){var self = TMP_45.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'MouseEvent').$new(type, button, nil, x, y, nil, nil))}, TMP_45.$$s = self, TMP_45.$$arity = 2, TMP_45))}
        else if ("scroll"['$===']($case)) {return $send(self.events['$[]']("mouse_scroll"), 'each', [], (TMP_46 = function(id, e){var self = TMP_46.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'MouseEvent').$new(type, nil, direction, nil, nil, delta_x, delta_y))}, TMP_46.$$s = self, TMP_46.$$arity = 2, TMP_46))}
        else if ("move"['$===']($case)) {return $send(self.events['$[]']("mouse_move"), 'each', [], (TMP_47 = function(id, e){var self = TMP_47.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'MouseEvent').$new(type, nil, nil, x, y, delta_x, delta_y))}, TMP_47.$$s = self, TMP_47.$$arity = 2, TMP_47))}
        else { return nil }})();
      }, TMP_Window_mouse_callback_48.$$arity = 7);
      
      Opal.defn(self, '$controller_callback', TMP_Window_controller_callback_53 = function $$controller_callback(which, type, axis, value, button) {
        var TMP_49, TMP_50, TMP_51, TMP_52, self = this, $case = nil;

        
        $send(self.events['$[]']("controller"), 'each', [], (TMP_49 = function(id, e){var self = TMP_49.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'ControllerEvent').$new(which, type, axis, value, button))}, TMP_49.$$s = self, TMP_49.$$arity = 2, TMP_49));
        return (function() {$case = type;
        if ("axis"['$===']($case)) {return $send(self.events['$[]']("controller_axis"), 'each', [], (TMP_50 = function(id, e){var self = TMP_50.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'ControllerAxisEvent').$new(which, axis, value))}, TMP_50.$$s = self, TMP_50.$$arity = 2, TMP_50))}
        else if ("button_down"['$===']($case)) {return $send(self.events['$[]']("controller_button_down"), 'each', [], (TMP_51 = function(id, e){var self = TMP_51.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'ControllerButtonEvent').$new(which, button))}, TMP_51.$$s = self, TMP_51.$$arity = 2, TMP_51))}
        else if ("button_up"['$===']($case)) {return $send(self.events['$[]']("controller_button_up"), 'each', [], (TMP_52 = function(id, e){var self = TMP_52.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call(Opal.const_get_relative($nesting, 'ControllerButtonEvent').$new(which, button))}, TMP_52.$$s = self, TMP_52.$$arity = 2, TMP_52))}
        else { return nil }})();
      }, TMP_Window_controller_callback_53.$$arity = 5);
      
      Opal.defn(self, '$update_callback', TMP_Window_update_callback_54 = function $$update_callback() {
        var self = this;

        return self.update_proc.$call()
      }, TMP_Window_update_callback_54.$$arity = 0);
      
      Opal.defn(self, '$show', TMP_Window_show_55 = function $$show() {
        var self = this;

        return self.$ext_show()
      }, TMP_Window_show_55.$$arity = 0);
      
      Opal.defn(self, '$close', TMP_Window_close_56 = function $$close() {
        var self = this;

        return self.$ext_close()
      }, TMP_Window_close_56.$$arity = 0);
      self.$private();
      return (Opal.defn(self, '$add_object', TMP_Window_add_object_58 = function $$add_object(o) {
        var TMP_57, self = this, index = nil;

        if ($truthy(self.objects['$include?'](o)['$!']())) {
          
          index = $send(self.objects, 'index', [], (TMP_57 = function(object){var self = TMP_57.$$s || this;
if (object == null) object = nil;
          return $rb_gt(object.$z(), o.$z())}, TMP_57.$$s = self, TMP_57.$$arity = 1, TMP_57));
          if ($truthy(index)) {
      ...
      }, TMP_Window_add_object_58.$$arity = 1), nil) && 'add_object';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Application, self = $Application = $module($base, 'Application');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting);

    (function(self, $parent_nesting) {
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_get_59, TMP_set_60, TMP_on_61, TMP_off_62, TMP_add_63, TMP_remove_64, TMP_clear_65, TMP_update_66, TMP_show_67, TMP_close_68;

      
      (Opal.class_variable_set($Application, '@@window', Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ruby2D'), 'Window').$new()));
      
      Opal.defn(self, '$get', TMP_get_59 = function $$get(sym) {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$get(sym)
      }, TMP_get_59.$$arity = 1);
      
      Opal.defn(self, '$set', TMP_set_60 = function $$set(opts) {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$set(opts)
      }, TMP_set_60.$$arity = 1);
      
      Opal.defn(self, '$on', TMP_on_61 = function $$on(event) {
        var $a, self = this, $iter = TMP_on_61.$$p, proc = $iter || nil;

        if ($iter) TMP_on_61.$$p = null;
        return $send((($a = $Application.$$cvars['@@window']) == null ? nil : $a), 'on', [event], proc.$to_proc())
      }, TMP_on_61.$$arity = 1);
      
      Opal.defn(self, '$off', TMP_off_62 = function $$off(event_descriptor) {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$off(event_descriptor)
      }, TMP_off_62.$$arity = 1);
      
      Opal.defn(self, '$add', TMP_add_63 = function $$add(o) {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$add(o)
      }, TMP_add_63.$$arity = 1);
      
      Opal.defn(self, '$remove', TMP_remove_64 = function $$remove(o) {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$remove(o)
      }, TMP_remove_64.$$arity = 1);
      
      Opal.defn(self, '$clear', TMP_clear_65 = function $$clear() {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$clear()
      }, TMP_clear_65.$$arity = 0);
      
      Opal.defn(self, '$update', TMP_update_66 = function $$update() {
        var $a, self = this, $iter = TMP_update_66.$$p, proc = $iter || nil;

        if ($iter) TMP_update_66.$$p = null;
        return $send((($a = $Application.$$cvars['@@window']) == null ? nil : $a), 'update', [], proc.$to_proc())
      }, TMP_update_66.$$arity = 0);
      
      Opal.defn(self, '$show', TMP_show_67 = function $$show() {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$show()
      }, TMP_show_67.$$arity = 0);
      return (Opal.defn(self, '$close', TMP_close_68 = function $$close() {
        var $a, self = this;

        return (($a = $Application.$$cvars['@@window']) == null ? nil : $a).$close()
      }, TMP_close_68.$$arity = 0), nil) && 'close';
    })(Opal.get_singleton_class(self), $nesting)
  })(Opal.const_get_relative($nesting, 'Ruby2D'), $nesting);
  (function($base, $parent_nesting) {
    var $DSL, self = $DSL = $module($base, 'DSL');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_DSL_get_69, TMP_DSL_set_70, TMP_DSL_on_71, TMP_DSL_off_72, TMP_DSL_update_73, TMP_DSL_clear_74, TMP_DSL_show_75, TMP_DSL_close_76;

    
    
    Opal.defn(self, '$get', TMP_DSL_get_69 = function $$get(sym) {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$get(sym)
    }, TMP_DSL_get_69.$$arity = 1);
    
    Opal.defn(self, '$set', TMP_DSL_set_70 = function $$set(opts) {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$set(opts)
    }, TMP_DSL_set_70.$$arity = 1);
    
    Opal.defn(self, '$on', TMP_DSL_on_71 = function $$on(event) {
      var self = this, $iter = TMP_DSL_on_71.$$p, proc = $iter || nil;

      if ($iter) TMP_DSL_on_71.$$p = null;
      return $send(Opal.const_get_relative($nesting, 'Application'), 'on', [event], proc.$to_proc())
    }, TMP_DSL_on_71.$$arity = 1);
    
    Opal.defn(self, '$off', TMP_DSL_off_72 = function $$off(event_descriptor) {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$off(event_descriptor)
    }, TMP_DSL_off_72.$$arity = 1);
    
    Opal.defn(self, '$update', TMP_DSL_update_73 = function $$update() {
      var self = this, $iter = TMP_DSL_update_73.$$p, proc = $iter || nil;

      if ($iter) TMP_DSL_update_73.$$p = null;
      return $send(Opal.const_get_relative($nesting, 'Application'), 'update', [], proc.$to_proc())
    }, TMP_DSL_update_73.$$arity = 0);
    
    Opal.defn(self, '$clear', TMP_DSL_clear_74 = function $$clear() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$clear()
    }, TMP_DSL_clear_74.$$arity = 0);
    
    Opal.defn(self, '$show', TMP_DSL_show_75 = function $$show() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$show()
    }, TMP_DSL_show_75.$$arity = 0);
    
    Opal.defn(self, '$close', TMP_DSL_close_76 = function $$close() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Application').$close()
    }, TMP_DSL_close_76.$$arity = 0);
  })(Opal.const_get_relative($nesting, 'Ruby2D'), $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      function $Quad(){};
      var self = $Quad = $klass($base, $super, 'Quad', $Quad);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Quad_initialize_77, TMP_Quad_color$eq_78, TMP_Quad_contains$q_79, TMP_Quad_triangle_area_80, TMP_Quad_update_color_81;

      def.color = def.x1 = def.y1 = def.x2 = def.y2 = def.x3 = def.y3 = def.x4 = def.y4 = nil;
      
      self.$include(Opal.const_get_relative($nesting, 'Renderable'));
      self.$attr_accessor("x1", "y1", "c1", "x2", "y2", "c2", "x3", "y3", "c3", "x4", "y4", "c4");
      self.$attr_reader("color");
      
      Opal.defn(self, '$initialize', TMP_Quad_initialize_77 = function $$initialize(opts) {
        ...
        self.x1 = ($truthy($a = opts['$[]']("x1")) ? $a : 0);
        self.y1 = ($truthy($a = opts['$[]']("y1")) ? $a : 0);
        self.x2 = ($truthy($a = opts['$[]']("x2")) ? $a : 100);
        self.y2 = ($truthy($a = opts['$[]']("y2")) ? $a : 0);
        self.x3 = ($truthy($a = opts['$[]']("x3")) ? $a : 100);
        self.y3 = ($truthy($a = opts['$[]']("y3")) ? $a : 100);
        self.x4 = ($truthy($a = opts['$[]']("x4")) ? $a : 0);
        self.y4 = ($truthy($a = opts['$[]']("y4")) ? $a : 100);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        
        $writer = [($truthy($a = opts['$[]']("color")) ? $a : "white")];
        $send(self, 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        return self.$add();
      }, TMP_Quad_initialize_77.$$arity = -1);
      
      Opal.defn(self, '$color=', TMP_Quad_color$eq_78 = function(c) {
        var self = this;

        
        self.color = Opal.const_get_relative($nesting, 'Color').$from(c);
        return self.$update_color(self.color);
      }, TMP_Quad_color$eq_78.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Quad_contains$q_79 = function(x, y) {
        var self = this, self_area = nil, questioned_area = nil;

        
        self_area = $rb_plus(self.$triangle_area(self.x1, self.y1, self.x2, self.y2, self.x3, self.y3), self.$triangle_area(self.x1, self.y1, self.x3, self.y3, self.x4, self.y4));
        questioned_area = $rb_plus($rb_plus($rb_plus(self.$triangle_area(self.x1, self.y1, self.x2, self.y2, x, y), self.$triangle_area(self.x2, self.y2, self.x3, self.y3, x, y)), self.$triangle_area(self.x3, self.y3, self.x4, self.y4, x, y)), self.$triangle_area(self.x4, self.y4, self.x1, self.y1, x, y));
        return $rb_le(questioned_area, self_area);
      }, TMP_Quad_contains$q_79.$$arity = 2);
      self.$private();
      
      Opal.defn(self, '$triangle_area', TMP_Quad_triangle_area_80 = function $$triangle_area(x1, y1, x2, y2, x3, y3) {
        var self = this;

        return $rb_divide($rb_minus($rb_minus($rb_minus($rb_plus($rb_plus($rb_times(x1, y2), $rb_times(x2, y3)), $rb_times(x3, y1)), $rb_times(x3, y2)), $rb_times(x1, y3)), $rb_times(x2, y1)).$abs(), 2)
      }, TMP_Quad_triangle_area_80.$$arity = 6);
      return (Opal.defn(self, '$update_color', TMP_Quad_update_color_81 = function $$update_color(c) {
        var self = this;

        if ($truthy(c['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Color'), 'Set')))) {
          if (c.$length()['$=='](4)) {
            ...
            return self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "Quads require 4 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
      ...
      }, TMP_Quad_update_color_81.$$arity = 1), nil) && 'update_color';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Line_initialize_82, TMP_Line_color$eq_83, TMP_Line_length_84, TMP_Line_contains$q_85, TMP_Line_points_distance_86, TMP_Line_update_color_87;

      def.color = def.x1 = def.y1 = def.x2 = def.y2 = def.width = nil;
      
      self.$include(Opal.const_get_relative($nesting, 'Renderable'));
      self.$attr_accessor("x1", "x2", "y1", "y2", "color", "width");
      
      Opal.defn(self, '$initialize', TMP_Line_initialize_82 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.y1 = ($truthy($a = opts['$[]']("y1")) ? $a : 0);
        self.x2 = ($truthy($a = opts['$[]']("x2")) ? $a : 100);
        self.y2 = ($truthy($a = opts['$[]']("y2")) ? $a : 100);
        self.width = ($truthy($a = opts['$[]']("width")) ? $a : 2);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return self.$add();
      }, TMP_Line_initialize_82.$$arity = -1);
      
      Opal.defn(self, '$color=', TMP_Line_color$eq_83 = function(c) {
        var self = this;

        
        self.color = Opal.const_get_relative($nesting, 'Color').$from(c);
        return self.$update_color(self.color);
      }, TMP_Line_color$eq_83.$$arity = 1);
      
      Opal.defn(self, '$length', TMP_Line_length_84 = function $$length() {
        var self = this;

        return self.$points_distance(self.x1, self.y1, self.x2, self.y2)
      }, TMP_Line_length_84.$$arity = 0);
      
      Opal.defn(self, '$contains?', TMP_Line_contains$q_85 = function(x, y) {
        var $a, $b, self = this;

        return ($truthy($a = ($truthy($b = $rb_lt(self.$points_distance(self.$x1(), self.$y1(), x, y), self.$length())) ? $rb_lt(self.$points_distance(self.$x2(), self.$y2(), x, y), self.$length()) : $b)) ? $rb_lt($rb_divide($rb_minus($rb_plus($rb_minus($rb_times($rb_minus(self.y2, self.y1), x), $rb_times($rb_minus(self.x2, self.x1), y)), $rb_times(self.x2, self.y1)), $rb_times(self.y2, self.x1)).$abs(), self.$length()), $rb_times(0.5, self.width)) : $a)
      }, TMP_Line_contains$q_85.$$arity = 2);
      self.$private();
      
      Opal.defn(self, '$points_distance', TMP_Line_points_distance_86 = function $$points_distance(x1, y1, x2, y2) {
        var self = this;

        return Opal.const_get_relative($nesting, 'Math').$sqrt($rb_plus($rb_minus(x1, x2)['$**'](2), $rb_minus(y1, y2)['$**'](2)))
      }, TMP_Line_points_distance_86.$$arity = 4);
      return (Opal.defn(self, '$update_color', TMP_Line_update_color_87 = function $$update_color(c) {
        var self = this;
        ...
        if ($truthy(c['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Color'), 'Set')))) {
          if (c.$length()['$=='](4)) {
            ...
            return self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "Lines require 4 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
      ...
      }, TMP_Line_update_color_87.$$arity = 1), nil) && 'update_color';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      function $Rectangle(){};
      var self = $Rectangle = $klass($base, $super, 'Rectangle', $Rectangle);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Rectangle_initialize_88, TMP_Rectangle_x$eq_89, TMP_Rectangle_y$eq_90, TMP_Rectangle_width$eq_91, TMP_Rectangle_height$eq_92, TMP_Rectangle_contains$q_93, TMP_Rectangle_update_coords_94;

      def.x = def.y = def.width = def.height = nil;
      
      self.$attr_reader("x", "y", "width", "height");
      
      Opal.defn(self, '$initialize', TMP_Rectangle_initialize_88 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.x = ($truthy($a = opts['$[]']("x")) ? $a : 0);
        self.y = ($truthy($a = opts['$[]']("y")) ? $a : 0);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        self.width = ($truthy($a = opts['$[]']("width")) ? $a : 200);
        self.height = ($truthy($a = opts['$[]']("height")) ? $a : 100);
        self.$update_coords(self.x, self.y, self.width, self.height);
        
        $writer = [($truthy($a = opts['$[]']("color")) ? $a : "white")];
        $send(self, 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        return self.$add();
      }, TMP_Rectangle_initialize_88.$$arity = -1);
      
      Opal.defn(self, '$x=', TMP_Rectangle_x$eq_89 = function(x) {
        var self = this;

        
        self.x = (self.x1 = x);
        self.x2 = $rb_plus(x, self.width);
        self.x3 = $rb_plus(x, self.width);
        return (self.x4 = x);
      }, TMP_Rectangle_x$eq_89.$$arity = 1);
      
      Opal.defn(self, '$y=', TMP_Rectangle_y$eq_90 = function(y) {
        var self = this;

        
        self.y = (self.y1 = y);
        self.y2 = y;
        self.y3 = $rb_plus(y, self.height);
        return (self.y4 = $rb_plus(y, self.height));
      }, TMP_Rectangle_y$eq_90.$$arity = 1);
      
      Opal.defn(self, '$width=', TMP_Rectangle_width$eq_91 = function(w) {
        var self = this;

        
        self.width = w;
        return self.$update_coords(self.x, self.y, w, self.height);
      }, TMP_Rectangle_width$eq_91.$$arity = 1);
      
      Opal.defn(self, '$height=', TMP_Rectangle_height$eq_92 = function(h) {
        var self = this;

        
        self.height = h;
        return self.$update_coords(self.x, self.y, self.width, h);
      }, TMP_Rectangle_height$eq_92.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Rectangle_contains$q_93 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($truthy($a = ($truthy($b = ($truthy($c = $rb_lt(self.x, x)) ? $rb_gt($rb_plus(self.x, self.width), x) : $c)) ? $rb_lt(self.y, y) : $b)) ? $rb_gt($rb_plus(self.y, self.height), y) : $a)
      }, TMP_Rectangle_contains$q_93.$$arity = 2);
      self.$private();
      return (Opal.defn(self, '$update_coords', TMP_Rectangle_update_coords_94 = function $$update_coords(x, y, w, h) {
        var self = this;
        ...
        self.y4 = $rb_plus(y, h);
        self.x3 = $rb_plus(x, w);
        return (self.y3 = $rb_plus(y, h));
      }, TMP_Rectangle_update_coords_94.$$arity = 4), nil) && 'update_coords';
    })($nesting[0], Opal.const_get_relative($nesting, 'Quad'), $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Square_initialize_95, TMP_Square_size$eq_96;

      def.x = def.y = def.size = nil;
      
      self.$attr_reader("size");
      
      Opal.defn(self, '$initialize', TMP_Square_initialize_95 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.y = ($truthy($a = opts['$[]']("y")) ? $a : 0);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        self.width = (self.height = (self.size = ($truthy($a = opts['$[]']("size")) ? $a : 100)));
        
        $writer = [($truthy($a = opts['$[]']("color")) ? $a : "white")];
        $send(self, 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        self.$update_coords(self.x, self.y, self.size, self.size);
        return self.$add();
      }, TMP_Square_initialize_95.$$arity = -1);
      
      Opal.defn(self, '$size=', TMP_Square_size$eq_96 = function(s) {
        var self = this, $writer = nil;

        
        $writer = [(($writer = [(self.size = s)]), $send(self, 'height=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)])];
        $send(self, 'width=', Opal.to_a($writer));
        return $writer[$rb_minus($writer["length"], 1)];
      }, TMP_Square_size$eq_96.$$arity = 1);
      return self.$private("width=", "height=");
    })($nesting[0], Opal.const_get_relative($nesting, 'Rectangle'), $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      function $Triangle(){};
      var self = $Triangle = $klass($base, $super, 'Triangle', $Triangle);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Triangle_initialize_97, TMP_Triangle_color$eq_98, TMP_Triangle_contains$q_99, TMP_Triangle_triangle_area_100, TMP_Triangle_update_color_101;

      def.color = def.x1 = def.y1 = def.x2 = def.y2 = def.x3 = def.y3 = nil;
      
      self.$include(Opal.const_get_relative($nesting, 'Renderable'));
      self.$attr_accessor("x1", "y1", "c1", "x2", "y2", "c2", "x3", "y3", "c3");
      self.$attr_reader("color", "type_id");
      
      Opal.defn(self, '$initialize', TMP_Triangle_initialize_97 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.x1 = ($truthy($a = opts['$[]']("x1")) ? $a : 50);
        self.y1 = ($truthy($a = opts['$[]']("y1")) ? $a : 0);
        self.x2 = ($truthy($a = opts['$[]']("x2")) ? $a : 100);
        self.y2 = ($truthy($a = opts['$[]']("y2")) ? $a : 100);
        self.x3 = ($truthy($a = opts['$[]']("x3")) ? $a : 0);
        self.y3 = ($truthy($a = opts['$[]']("y3")) ? $a : 100);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return self.$add();
      }, TMP_Triangle_initialize_97.$$arity = -1);
      
      Opal.defn(self, '$color=', TMP_Triangle_color$eq_98 = function(c) {
        var self = this;

        
        self.color = Opal.const_get_relative($nesting, 'Color').$from(c);
        return self.$update_color(self.color);
      }, TMP_Triangle_color$eq_98.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Triangle_contains$q_99 = function(x, y) {
        var self = this, self_area = nil, questioned_area = nil;

        
        self_area = self.$triangle_area(self.x1, self.y1, self.x2, self.y2, self.x3, self.y3);
        questioned_area = $rb_plus($rb_plus(self.$triangle_area(self.x1, self.y1, self.x2, self.y2, x, y), self.$triangle_area(self.x2, self.y2, self.x3, self.y3, x, y)), self.$triangle_area(self.x3, self.y3, self.x1, self.y1, x, y));
        return $rb_le(questioned_area, self_area);
      }, TMP_Triangle_contains$q_99.$$arity = 2);
      self.$private();
      
      Opal.defn(self, '$triangle_area', TMP_Triangle_triangle_area_100 = function $$triangle_area(x1, y1, x2, y2, x3, y3) {
        var self = this;

        return $rb_divide($rb_minus($rb_minus($rb_minus($rb_plus($rb_plus($rb_times(x1, y2), $rb_times(x2, y3)), $rb_times(x3, y1)), $rb_times(x3, y2)), $rb_times(x1, y3)), $rb_times(x2, y1)).$abs(), 2)
      }, TMP_Triangle_triangle_area_100.$$arity = 6);
      return (Opal.defn(self, '$update_color', TMP_Triangle_update_color_101 = function $$update_color(c) {
        var self = this;
        ...
        if ($truthy(c['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Color'), 'Set')))) {
          if (c.$length()['$=='](3)) {
            ...
            return self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "Triangles require 3 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
      ...
      }, TMP_Triangle_update_color_101.$$arity = 1), nil) && 'update_color';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Image_initialize_102, TMP_Image_color$eq_103, TMP_Image_contains$q_104;

      def.path = def.x = def.width = def.y = def.height = nil;
      
      self.$include(Opal.const_get_relative($nesting, 'Renderable'));
      self.$attr_accessor("x", "y", "width", "height", "data");
      self.$attr_reader("path", "color");
      
      Opal.defn(self, '$initialize', TMP_Image_initialize_102 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.y = ($truthy($a = opts['$[]']("y")) ? $a : 0);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        self.width = ($truthy($a = opts['$[]']("width")) ? $a : nil);
        self.height = ($truthy($a = opts['$[]']("height")) ? $a : nil);
        
        $writer = [($truthy($a = opts['$[]']("color")) ? $a : "white")];
        $send(self, 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        self.$ext_init(self.path);
        return self.$add();
      }, TMP_Image_initialize_102.$$arity = -1);
      
      Opal.defn(self, '$color=', TMP_Image_color$eq_103 = function(c) {
        var self = this;

        return (self.color = Opal.const_get_relative($nesting, 'Color').$new(c))
      }, TMP_Image_color$eq_103.$$arity = 1);
      return (Opal.defn(self, '$contains?', TMP_Image_contains$q_104 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($truthy($a = ($truthy($b = ($truthy($c = $rb_lt(self.x, x)) ? $rb_gt($rb_plus(self.x, self.width), x) : $c)) ? $rb_lt(self.y, y) : $b)) ? $rb_gt($rb_plus(self.y, self.height), y) : $a)
      }, TMP_Image_contains$q_104.$$arity = 2), nil) && 'contains?';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sprite_initialize_105, TMP_Sprite_start_106, TMP_Sprite_add_107, TMP_Sprite_animate_108, TMP_Sprite_reset_109, TMP_Sprite_remove_110, TMP_Sprite_clip_111, TMP_Sprite_animate_frames_112, TMP_Sprite_clip_with_current_frame_113;

      def.animations = def.current_animation = def["default"] = def.current_frame_time = def.current_frame = nil;
      
      self.$attr_accessor("x", "y", "clip_x", "clip_y", "clip_w", "clip_h", "data");
      self.$attr_reader("z");
      
      Opal.defn(self, '$initialize', TMP_Sprite_initialize_105 = function $$initialize(x, y, path, z) {
        var $a, self = this;
        ...
        $a = [x, y, path], (self.x = $a[0]), (self.y = $a[1]), (self.path = $a[2]), $a;
        $a = [0, 0, 0, 0], (self.clip_x = $a[0]), (self.clip_y = $a[1]), (self.clip_w = $a[2]), (self.clip_h = $a[3]), $a;
        self["default"] = nil;
        self.animations = $hash2([], {});
      ...
      }, TMP_Sprite_initialize_105.$$arity = -4);
      
      Opal.defn(self, '$start', TMP_Sprite_start_106 = function $$start(x, y, w, h) {
        var self = this;

        
        self["default"] = [x, y, w, h];
        return self.$clip(x, y, w, h);
      }, TMP_Sprite_start_106.$$arity = 4);
      
      Opal.defn(self, '$add', TMP_Sprite_add_107 = function $$add(animations) {
        var self = this;

        return self.animations['$merge!'](animations)
      }, TMP_Sprite_add_107.$$arity = 1);
      
      Opal.defn(self, '$animate', TMP_Sprite_animate_108 = function $$animate(animation) {
        var self = this;

        
        if ($truthy(self.current_animation['$!='](animation))) {
          
          self.current_frame = 0;
          self.current_frame_time = 0;
          self.current_animation = animation;};
        return self.$animate_frames(self.animations['$[]'](animation));
      }, TMP_Sprite_animate_108.$$arity = 1);
      
      Opal.defn(self, '$reset', TMP_Sprite_reset_109 = function $$reset() {
        var self = this;

        
        self.$clip(self["default"]['$[]'](0), self["default"]['$[]'](1), self["default"]['$[]'](2), self["default"]['$[]'](3));
        return (self.current_animation = nil);
      }, TMP_Sprite_reset_109.$$arity = 0);
      
      Opal.defn(self, '$remove', TMP_Sprite_remove_110 = function $$remove() {
        var self = this;
      ...
      }, TMP_Sprite_remove_110.$$arity = 0);
      self.$private();
      
      Opal.defn(self, '$clip', TMP_Sprite_clip_111 = function $$clip(x, y, w, h) {
        var $a, self = this;

        return $a = [x, y, w, h], (self.clip_x = $a[0]), (self.clip_y = $a[1]), (self.clip_w = $a[2]), (self.clip_h = $a[3]), $a
      }, TMP_Sprite_clip_111.$$arity = 4);
      
      Opal.defn(self, '$animate_frames', TMP_Sprite_animate_frames_112 = function $$animate_frames(frames) {
        var self = this;

        if ($truthy($rb_lt(self.current_frame_time, frames['$[]'](self.current_frame)['$[]'](4)))) {
          
          self.$clip_with_current_frame(frames);
          return (self.current_frame_time = $rb_plus(self.current_frame_time, 1));
          } else {
          
          self.current_frame = $rb_plus(self.current_frame, 1);
          if (self.current_frame['$=='](frames.$length())) {
            self.current_frame = 0};
          self.$clip_with_current_frame(frames);
          return (self.current_frame_time = 0);
        }
      }, TMP_Sprite_animate_frames_112.$$arity = 1);
      return (Opal.defn(self, '$clip_with_current_frame', TMP_Sprite_clip_with_current_frame_113 = function $$clip_with_current_frame(frames) {
        var self = this;

        return self.$clip(frames['$[]'](self.current_frame)['$[]'](0), frames['$[]'](self.current_frame)['$[]'](1), frames['$[]'](self.current_frame)['$[]'](2), frames['$[]'](self.current_frame)['$[]'](3))
      }, TMP_Sprite_clip_with_current_frame_113.$$arity = 1), nil) && 'clip_with_current_frame';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Text_initialize_114, TMP_Text_text$eq_115, TMP_Text_color$eq_116, TMP_Text_contains$q_117, TMP_Text_resolve_path_118;

      def.text = def.x = def.width = def.y = def.height = nil;
      
      self.$include(Opal.const_get_relative($nesting, 'Renderable'));
      self.$attr_accessor("x", "y", "data");
      self.$attr_reader("text", "size", "width", "height", "font", "color");
      
      Opal.defn(self, '$initialize', TMP_Text_initialize_114 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.y = ($truthy($a = opts['$[]']("y")) ? $a : 0);
        self.z = ($truthy($a = opts['$[]']("z")) ? $a : 0);
        self.text = ($truthy($a = opts['$[]']("text")) ? $a : "Hello World!").$to_s();
        self.size = ($truthy($a = opts['$[]']("size")) ? $a : 20);
        self.font = opts['$[]']("font");
        if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
          } else {
          nil
        ...
        self.$ext_init();
        return self.$add();
      }, TMP_Text_initialize_114.$$arity = -1);
      
      Opal.defn(self, '$text=', TMP_Text_text$eq_115 = function(msg) {
        var self = this;

        
        self.text = msg.$to_s();
        return self.$ext_set(self.text);
      }, TMP_Text_text$eq_115.$$arity = 1);
      
      Opal.defn(self, '$color=', TMP_Text_color$eq_116 = function(c) {
        var self = this;

        return (self.color = Opal.const_get_relative($nesting, 'Color').$new(c))
      }, TMP_Text_color$eq_116.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Text_contains$q_117 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($truthy($a = ($truthy($b = ($truthy($c = $rb_lt(self.x, x)) ? $rb_gt($rb_plus(self.x, self.width), x) : $c)) ? $rb_lt(self.y, y) : $b)) ? $rb_gt($rb_plus(self.y, self.height), y) : $a)
      }, TMP_Text_contains$q_117.$$arity = 2);
      self.$private();
      return (Opal.defn(self, '$resolve_path', TMP_Text_resolve_path_118 = function $$resolve_path(font) {
        var self = this, font_path = nil;

        
        if ($truthy(Opal.const_get_relative($nesting, 'RUBY_PLATFORM')['$=~'](/darwin/))) {
          font_path = "" + "/Library/Fonts/" + (font) + ".ttf"
          } else {
          font_path = "" + "/usr/share/fonts/truetype/" + (font) + ".ttf"
        };
        if ($truthy(Opal.const_get_relative($nesting, 'File')['$exists?'](font_path))) {
          return font_path
          } else {
          return self.$raise(Opal.const_get_relative($nesting, 'Error'), "Cannot find system font")
        };
      }, TMP_Text_resolve_path_118.$$arity = 1), nil) && 'resolve_path';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sound_initialize_119, TMP_Sound_play_120;

      
      self.$attr_accessor("data");
      self.$attr_reader("path");
      
      Opal.defn(self, '$initialize', TMP_Sound_initialize_119 = function $$initialize(path) {
        var self = this;
        ...
        self.path = path;
        return self.$ext_init(path);
      }, TMP_Sound_initialize_119.$$arity = 1);
      return (Opal.defn(self, '$play', TMP_Sound_play_120 = function $$play() {
        var self = this;

        return self.$ext_play()
      }, TMP_Sound_play_120.$$arity = 0), nil) && 'play';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      function $Music(){};
      var self = $Music = $klass($base, $super, 'Music', $Music);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Music_initialize_121, TMP_Music_play_122, TMP_Music_pause_123, TMP_Music_resume_124, TMP_Music_stop_125, TMP_Music_fadeout_126;

      
      self.$attr_accessor("data", "loop");
      self.$attr_reader("path");
      
      Opal.defn(self, '$initialize', TMP_Music_initialize_121 = function $$initialize(path) {
        var self = this;
        ...
        self.loop = false;
        return self.$ext_init(path);
      }, TMP_Music_initialize_121.$$arity = 1);
      
      Opal.defn(self, '$play', TMP_Music_play_122 = function $$play() {
        var self = this;

        return self.$ext_play()
      }, TMP_Music_play_122.$$arity = 0);
      
      Opal.defn(self, '$pause', TMP_Music_pause_123 = function $$pause() {
        var self = this;

        return self.$ext_pause()
      }, TMP_Music_pause_123.$$arity = 0);
      
      Opal.defn(self, '$resume', TMP_Music_resume_124 = function $$resume() {
        var self = this;

        return self.$ext_resume()
      }, TMP_Music_resume_124.$$arity = 0);
      
      Opal.defn(self, '$stop', TMP_Music_stop_125 = function $$stop() {
        var self = this;

        return self.$ext_stop()
      }, TMP_Music_stop_125.$$arity = 0);
      return (Opal.defn(self, '$fadeout', TMP_Music_fadeout_126 = function $$fadeout(ms) {
        var self = this;

        return self.$ext_fadeout(ms)
      }, TMP_Music_fadeout_126.$$arity = 1), nil) && 'fadeout';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ruby2D'), 'DSL'));
  return self.$include(Opal.const_get_relative($nesting, 'Ruby2D'));
})(Opal);
...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $send = Opal.send, $module = Opal.module, $klass = Opal.klass, type = nil, direction = nil, button = nil, $writer = nil;
  if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;

  Opal.add_stubs(['$key_callback', '$mouse_callback', '$mouse_x=', '$-', '$mouse_y=', '$frames=', '$fps=', '$update_callback', '$r', '$get', '$g', '$b', '$a', '$objects']);
  
  $gvars.R2D_WINDOW = nil;
...
function on_key(e) {
  ...
  $gvars.R2D_WINDOW.$key_callback(type, e.key);
}
...
function on_mouse(e) {
  ...
  $gvars.R2D_WINDOW.$mouse_callback(type, button, direction, e.x, e.y, e.delta_x, e.delta_y);
}


function update() {
  (($writer = [win.mouse.x]), $send($gvars.R2D_WINDOW, 'mouse_x=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]);
  (($writer = [win.mouse.y]), $send($gvars.R2D_WINDOW, 'mouse_y=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]);
  (($writer = [win.frames]), $send($gvars.R2D_WINDOW, 'frames=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]);
  (($writer = [win.fps]), $send($gvars.R2D_WINDOW, 'fps=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]);
  $gvars.R2D_WINDOW.$update_callback();
}
...
function render() {
  ...
  win.background.r = $gvars.R2D_WINDOW.$get("background").$r();
  win.background.g = $gvars.R2D_WINDOW.$get("background").$g();
  win.background.b = $gvars.R2D_WINDOW.$get("background").$b();
  win.background.a = $gvars.R2D_WINDOW.$get("background").$a();

  var objects = $gvars.R2D_WINDOW.$objects();
...
;
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Triangle_ext_render_1;

      return (Opal.defn(self, '$ext_render', TMP_Triangle_ext_render_1 = function $$ext_render() {
        var self = this;

        return S2D.DrawTriangle(
      ...
      }, TMP_Triangle_ext_render_1.$$arity = 0), nil) && 'ext_render'
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Quad(){};
      var self = $Quad = $klass($base, $super, 'Quad', $Quad);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Quad_ext_render_2;

      return (Opal.defn(self, '$ext_render', TMP_Quad_ext_render_2 = function $$ext_render() {
        var self = this;
      ...
      }, TMP_Quad_ext_render_2.$$arity = 0), nil) && 'ext_render'
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Line(){};
      var self = $Line = $klass($base, $super, 'Line', $Line);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Line_ext_render_3;

      return (Opal.defn(self, '$ext_render', TMP_Line_ext_render_3 = function $$ext_render() {
        var self = this;
      ...
      }, TMP_Line_ext_render_3.$$arity = 0), nil) && 'ext_render'
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Image(){};
      var self = $Image = $klass($base, $super, 'Image', $Image);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Image_ext_init_4, TMP_Image_ext_render_5;

      def.width = def.height = nil;
      
      
      Opal.defn(self, '$ext_init', TMP_Image_ext_init_4 = function $$ext_init(path) {
        var self = this;

        
      self.data = S2D.CreateImage(path, function() {
        if (self.width == Opal.nil) {
          self.width = self.data.width;
        }
        if (self.height == Opal.nil) {
          self.height = self.data.height;
        }
      });
      
      }, TMP_Image_ext_init_4.$$arity = 1);
      return (Opal.defn(self, '$ext_render', TMP_Image_ext_render_5 = function $$ext_render() {
        var self = this;
      ...
      }, TMP_Image_ext_render_5.$$arity = 0), nil) && 'ext_render';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Sprite(){};
      var self = $Sprite = $klass($base, $super, 'Sprite', $Sprite);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sprite_ext_init_6, TMP_Sprite_ext_render_7;

      
      
      Opal.defn(self, '$ext_init', TMP_Sprite_ext_init_6 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateSprite(path);
      }, TMP_Sprite_ext_init_6.$$arity = 1);
      return (Opal.defn(self, '$ext_render', TMP_Sprite_ext_render_7 = function $$ext_render() {
        var self = this;
      ...
      }, TMP_Sprite_ext_render_7.$$arity = 0), nil) && 'ext_render';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Text(){};
      var self = $Text = $klass($base, $super, 'Text', $Text);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Text_ext_init_8, TMP_Text_ext_set_9, TMP_Text_ext_render_10;

      def.width = def.height = nil;
      
      
      Opal.defn(self, '$ext_init', TMP_Text_ext_init_8 = function $$ext_init() {
        var self = this;
      ...
      }, TMP_Text_ext_init_8.$$arity = 0);
      
      Opal.defn(self, '$ext_set', TMP_Text_ext_set_9 = function $$ext_set(msg) {
        var self = this;
      ...
      }, TMP_Text_ext_set_9.$$arity = 1);
      return (Opal.defn(self, '$ext_render', TMP_Text_ext_render_10 = function $$ext_render() {
        var self = this;
      ...
      }, TMP_Text_ext_render_10.$$arity = 0), nil) && 'ext_render';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Sound(){};
      var self = $Sound = $klass($base, $super, 'Sound', $Sound);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sound_ext_init_11, TMP_Sound_ext_play_12;

      
      
      Opal.defn(self, '$ext_init', TMP_Sound_ext_init_11 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateSound(path);
      }, TMP_Sound_ext_init_11.$$arity = 1);
      return (Opal.defn(self, '$ext_play', TMP_Sound_ext_play_12 = function $$ext_play() {
        var self = this;

        return S2D.PlaySound(self.data);
      }, TMP_Sound_ext_play_12.$$arity = 0), nil) && 'ext_play';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Music(){};
      var self = $Music = $klass($base, $super, 'Music', $Music);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Music_ext_init_13, TMP_Music_ext_play_14, TMP_Music_ext_pause_15, TMP_Music_ext_resume_16, TMP_Music_ext_stop_17, TMP_Music_ext_music_fadeout_18;

      
      
      Opal.defn(self, '$ext_init', TMP_Music_ext_init_13 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateMusic(path);
      }, TMP_Music_ext_init_13.$$arity = 1);
      
      Opal.defn(self, '$ext_play', TMP_Music_ext_play_14 = function $$ext_play() {
        var self = this;

        return S2D.PlayMusic(self.data, self.loop);
      }, TMP_Music_ext_play_14.$$arity = 0);
      
      Opal.defn(self, '$ext_pause', TMP_Music_ext_pause_15 = function $$ext_pause() {
        var self = this;

        return S2D.PauseMusic();
      }, TMP_Music_ext_pause_15.$$arity = 0);
      
      Opal.defn(self, '$ext_resume', TMP_Music_ext_resume_16 = function $$ext_resume() {
        var self = this;

        return S2D.ResumeMusic();
      }, TMP_Music_ext_resume_16.$$arity = 0);
      
      Opal.defn(self, '$ext_stop', TMP_Music_ext_stop_17 = function $$ext_stop() {
        var self = this;

        return S2D.StopMusic();
      }, TMP_Music_ext_stop_17.$$arity = 0);
      return (Opal.defn(self, '$ext_music_fadeout', TMP_Music_ext_music_fadeout_18 = function $$ext_music_fadeout(ms) {
        var self = this;

        return S2D.FadeOutMusic(ms);
      }, TMP_Music_ext_music_fadeout_18.$$arity = 1), nil) && 'ext_music_fadeout';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Window(){};
      var self = $Window = $klass($base, $super, 'Window', $Window);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Window_ext_show_19;

      return (Opal.defn(self, '$ext_show', TMP_Window_ext_show_19 = function $$ext_show() {
        var self = this;
        if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;

        
        $gvars.R2D_WINDOW = self;
        
      var width  = $gvars.R2D_WINDOW.$get("width");
      var height = $gvars.R2D_WINDOW.$get("height");

      var vp_w = $gvars.R2D_WINDOW.$get("viewport_width");
      var viewport_width = vp_w != Opal.nil ? vp_w : width;

      var vp_h = $gvars.R2D_WINDOW.$get("viewport_height");
      var viewport_height = vp_h != Opal.nil ? vp_h : height;

      win = S2D.CreateWindow(
        $gvars.R2D_WINDOW.$get("title"), width, height, update, render, "ruby2d-app", {}
      );
      ...
      S2D.Show(win);
      ;
      }, TMP_Window_ext_show_19.$$arity = 0), nil) && 'ext_show'
    })($nesting[0], null, $nesting);
  })($nesting[0], $nesting);
})(Opal);
...
(function(Opal) {
  ...
  board = Opal.const_get_relative($nesting, 'Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 0, "y": 0, "width": boardSize, "height": boardSize, "color": [1, 0.4, 0.28, 0.82]}));
  boardLines = [];
  $send($range(0, 4, false), 'each', [], (TMP_1 = function(i){var self = TMP_1.$$s || this;
if (i == null) i = nil;
  
    boardLines.$push(Opal.const_get_relative($nesting, 'Rectangle').$new($hash2(["x", "y", "width", "height", "z", "color"], {"x": 0, "y": $rb_plus($rb_plus($rb_divide(buffer, 4), $rb_times(i, buffer)), $rb_times($rb_times(4, size), i)), "width": boardSize, "height": $rb_divide(buffer, 2), "z": 0, "color": "black"})));
    return boardLines.$push(Opal.const_get_relative($nesting, 'Rectangle').$new($hash2(["x", "y", "width", "height", "z", "color"], {"x": $rb_plus($rb_plus($rb_divide(buffer, 4), $rb_times(i, buffer)), $rb_times($rb_times(4, size), i)), "y": 0, "width": $rb_divide(buffer, 2), "height": boardSize, "z": 0, "color": "black"})));}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1));
  border1 = Opal.const_get_relative($nesting, 'Rectangle').$new($hash2(["x", "y", "width", "height", "z", "color"], {"x": 0, "y": 0, "width": boardSize, "height": $rb_divide(buffer, 4), "z": 0, "color": "black"}));
  ...
  currIndex = 0;
  pieces = [];
  $send($range(1, 16, false), 'each', [], (TMP_2 = function(i){var self = TMP_2.$$s || this;
if (i == null) i = nil;
  return pieces.$push(Opal.const_get_relative($nesting, 'Square').$new($hash2(["x", "y", "size", "z", "color"], {"x": 0, "y": 0, "size": 0, "z": 0, "color": "blue"})))}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2));
  $send(grid, 'each', [], (TMP_3 = function(row){var self = TMP_3.$$s || this, TMP_4;
if (row == null) row = nil;
  
    $send(row, 'each', [], (TMP_4 = function(stack){var self = TMP_4.$$s || this, element = nil, $writer = nil, elementSize = nil;
if (stack == null) stack = nil;
    
      if ($truthy(stack['$empty?']())) {
        
        numCols = $rb_plus(numCols, 1);
        currIndex = $rb_plus(currIndex, 1);
        return nil;;};
      element = stack.$last();
      if (element['$[]'](1)['$==']("w")) {
        
        $writer = ["white"];
        $send(pieces['$[]'](currIndex), 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];
      } else if (element['$[]'](1)['$==']("b")) {
        ...
        $send(pieces['$[]'](currIndex), 'color=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];};
      elementSize = $rb_times(element['$[]'](0).$to_i(), size);
      
      $writer = [elementSize];
      $send(pieces['$[]'](currIndex), 'size=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [$rb_plus($rb_plus($rb_times(buffer, $rb_plus(numCols, 1)), $rb_times($rb_times(4, size), numCols)), $rb_divide($rb_times($rb_minus(4, element['$[]'](0).$to_i()), size), 2))];
      $send(pieces['$[]'](currIndex), 'x=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = [$rb_plus($rb_plus($rb_times(buffer, $rb_plus(numRows, 1)), $rb_times($rb_times(4, size), numRows)), $rb_divide($rb_times($rb_minus(4, element['$[]'](0).$to_i()), size), 2))];
      $send(pieces['$[]'](currIndex), 'y=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      numCols = $rb_plus(numCols, 1);
      return (currIndex = $rb_plus(currIndex, 1));}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
    numRows = $rb_plus(numRows, 1);
    return (numCols = 0);}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));
  piece = Opal.const_get_relative($nesting, 'Square').$new($hash2(["x", "y", "size", "z", "color"], {"x": 0, "y": 0, "size": 0, "z": 0, "color": "white"}));
  return self.$show();
})(Opal);
