...
(function(Opal) {
  ...
  var TMP_1, TMP_setSize1_3, TMP_setSize2_4, TMP_setSize3_5, TMP_setSize4_6, TMP_setWhite_7, TMP_setBlack_8, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, $send = Opal.send, size = nil, board = nil, $writer = nil, grid = nil, numRows = nil, numCols = nil, piece = nil;

  Opal.add_stubs(['$set', '$new', '$color=', '$-', '$each', '$+', '$size', '$size=', '$piece', '$*', '$show']);
  
  self.$set($hash2(["title"], {"title": "Testing Ruby 2D"}));
  size = 10;
  board = Opal.const_get_relative($nesting, 'Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 0, "y": 0, "width": 400, "height": 400, "color": ["#1dff00", "#fa00ff", "#00edff", "#c7ff00"]}));
  
  $writer = [[1, 0.4, 0.28, 0.82]];
  $send(board, 'color=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  grid = [[[], [], [], []], [[], [], [], []], [[], [], [], []], [[], [], [], []]];
  numRows = 0;
  numCols = 0;
  $send(grid, 'each', [], (TMP_1 = function(row){var self = TMP_1.$$s || this, TMP_2;
if (row == null) row = nil;
  
    $send(grid, 'each', [], (TMP_2 = function(element){var self = TMP_2.$$s || this;
if (element == null) element = nil;
    return (numCols = $rb_plus(numCols, 1))}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2));
    numRows = $rb_plus(numRows, 1);
    return (numCols = 0);}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1));
  piece = Opal.const_get_relative($nesting, 'Square').$new($hash2(["x", "y", "size", "z", "color"], {"x": 0, "y": 0, "size": 0, "z": 0, "color": "white"}));
  
  Opal.defn(Opal.Object, '$setSize1', TMP_setSize1_3 = function $$setSize1() {
    var self = this, $writer = nil;

    
    $writer = [self.$size()];
    $send(self.$piece(), 'size=', Opal.to_a($writer));
    return $writer[$rb_minus($writer["length"], 1)];
  }, TMP_setSize1_3.$$arity = 0);
  
  Opal.defn(Opal.Object, '$setSize2', TMP_setSize2_4 = function $$setSize2() {
    var self = this, $writer = nil;

    
    $writer = [$rb_times(2, self.$size())];
    $send(self.$piece(), 'size=', Opal.to_a($writer));
    return $writer[$rb_minus($writer["length"], 1)];
  }, TMP_setSize2_4.$$arity = 0);
  
  Opal.defn(Opal.Object, '$setSize3', TMP_setSize3_5 = function $$setSize3() {
    var self = this, $writer = nil;

    
    $writer = [$rb_times(3, self.$size())];
    $send(self.$piece(), 'size=', Opal.to_a($writer));
    return $writer[$rb_minus($writer["length"], 1)];
  }, TMP_setSize3_5.$$arity = 0);
  
  Opal.defn(Opal.Object, '$setSize4', TMP_setSize4_6 = function $$setSize4() {
    var self = this, $writer = nil;

    
    $writer = [$rb_times(4, self.$size())];
    $send(self.$piece(), 'size=', Opal.to_a($writer));
    return $writer[$rb_minus($writer["length"], 1)];
  }, TMP_setSize4_6.$$arity = 0);
  
  Opal.defn(Opal.Object, '$setWhite', TMP_setWhite_7 = function $$setWhite() {
    var self = this, $writer = nil;

    
    $writer = ["white"];
    $send(self.$piece(), 'color=', Opal.to_a($writer));
    return $writer[$rb_minus($writer["length"], 1)];
  }, TMP_setWhite_7.$$arity = 0);
  
  Opal.defn(Opal.Object, '$setBlack', TMP_setBlack_8 = function $$setBlack() {
    var self = this, $writer = nil;
